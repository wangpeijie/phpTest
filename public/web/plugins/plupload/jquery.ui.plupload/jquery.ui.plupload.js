				...
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_view_switch">' +
							'<input type="radio" id="'+obj.id+'_view_list" name="view_mode" checked="checked" /> <label class="plupload_button" for="'+obj.id+'_view_list" data-view="list">' + _('List') + '</label>' +
							...
							'<input type="radio" id="'+obj.id+'_view_thumbs" name="view_mode" /> <label class="plupload_button"  for="'+obj.id+'_view_thumbs" data-view="thumbs">' + _('Thumbnails') + '</label>' +
						'</div>' +
					'</div>' +
				'</div>' +
...
$.widget("ui.plupload", {
	...
	*/
	...
	_addFiles: function(files) {
		...
		self.filelist.siblings('div.plupload_droptext').hide();
