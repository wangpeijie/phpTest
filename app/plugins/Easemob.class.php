...
//------------------------------------------------------用户体系	
        ...
        {
                $this->client_id = 'YXA6IL9FELBaEeaH1ztan53XNw';
                $this->client_secret = 'YXA6OR5vet0ts2_d7XzA_E-gdHcGz3U';
                $this->org_name = '1171161025115716';
                $this->app_name = 'tuiya';
        ...
        /**
         * 批量注册用户
         * 批量注册的用户数量不要过多，建议在20-60之间。请求体如果超过5kb会导致413错误，需要拆成几个更小的请求体重试
         * $options = [['username' => 1, 'password' => 1], ['username' => 2, 'password' => 2]]
         */
        ...
        /**
         * 获取批量用户---分页
         * 该接口默认返回最早创建的10个用户，如果需要指定获取数量，需加上参数 limit=N，N 为数量值。
         * 关于分页：如果 DB 中的数量大于 N，返回 JSON 会携带一个字段“cursor”,我们把它叫做”游标”，该游标可理解为结果集的指针，值是变化的。
